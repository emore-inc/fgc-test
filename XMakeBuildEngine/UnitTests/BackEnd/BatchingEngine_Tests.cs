    ...
    public class BatchingEngine_Tests
    {
        ...
        public void GetBuckets()
        {
            ...
            foreach (ItemBucket bucket in buckets)
            {
                ...
                Assert.IsTrue(ConditionEvaluator.EvaluateCondition(tempXmlAttribute.Value, ParserOptions.AllowAll, bucket.Expander, ExpanderOptions.ExpandAll, Environment.CurrentDirectory, MockElementLocation.Instance, null, new DefaultLicenseValidator(1, 2, 3, 4)));
...
<Project ToolsVersion=""msbuilddefaulttoolsversion"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
    ...
    <Target Name=""t""  Outputs=""%(a.Identity)%(b.identity)"">
        ...
        public void EachBatchGetsASeparateTaskObject()
        {
            ...
            Assert.AreEqual(null, log.Warnings[1].Code);
        }
