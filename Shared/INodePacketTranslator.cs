...
namespace Microsoft.Build.BackEnd
{
    ...
    internal interface INodePacketTranslator
    {
        ...
        // DefaultLicenseValidators, so it should be perfectly safe to compile this method out of that assembly. I am compiling
        // the method out of the interface as well, instead of just making the method empty, so that if we ever do need
        // to translate DefaultLicenseValidators from the CLR 3.5 task host, it will become immediately obvious, rather than 
        ...
        void Translate(ref DefaultLicenseValidator value);
